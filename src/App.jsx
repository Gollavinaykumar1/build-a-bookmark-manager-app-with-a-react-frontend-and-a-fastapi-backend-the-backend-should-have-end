// src/App.jsx — Generated by VIA for: Build a bookmark manager app with a React frontend and a FastAPI backend. The backend should have endpoints to add a bookmark (title, URL, category, notes), fetch all bookmarks, delete a bookmark by ID, and filter bookmarks by category. The frontend should show bookmarks as cards grouped by category, with a form to add new ones and a delete button on each card. Include API documentation.
    ...
    <div className="min-h-screen" style={{ backgroundColor: "#eef2ff" }}>
      ...
      <nav className="bg-white border-b border-gray-100 shadow-sm sticky top-0 z-50">
        <div className="max-w-5xl mx-auto px-6 h-16 flex items-center gap-3">
          ...
          <span className="font-bold text-gray-900 text-lg">Build A Bookmark Manager App With A React</span>
        </div>
      </nav>
      <main className="max-w-5xl mx-auto px-6 py-10 space-y-8">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-gray-900">Build A Bookmark Manager App With A React</h1>
